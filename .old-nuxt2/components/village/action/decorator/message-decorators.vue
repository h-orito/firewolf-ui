<template>
  <div class="m-b-5">
    ...
    <decorate-button @click="addTag('large')"> 大 </decorate-button>
    ...
    <decorate-button @click="addRubyTag"> rb </decorate-button>
    <decorate-button @click="addTag('cw')"> 隠 </decorate-button>
