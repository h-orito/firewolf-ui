...
import { MessagePostForm } from '@/components/village/MessagePostForm'
import { VoteForm } from '@/components/pages/village/VoteForm'
import { AbilityForm } from '@/components/pages/village/AbilityForm'
import { CommitForm } from '@/components/pages/village/CommitForm'
import { ParticipationForm } from '@/components/pages/village/ParticipationForm'
import { LeaveForm } from '@/components/pages/village/LeaveForm'
