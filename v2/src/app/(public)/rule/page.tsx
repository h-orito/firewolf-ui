...
import { SkillList } from '@/components/pages/rule/SkillList'
    ...
    <div className="container mx-auto px-3 md:px-6 py-8">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <ul className="space-y-3 listUdisc listUinside">
              <li>
                ...
                <ul className="mt-2 ml-6 space-y-1 listUdisc listUinside">
                  <li>
        ...
        <section className="mb-8">
          ...
          <Card className="p-6">
            <ul className="space-y-2 listUdisc listUinside">
        ...
        <section className="mb-8">
          ...
          <Card className="p-6">
            <ul className="space-y-4 listUdisc listUinside">
              <li>
                プロローグ
                <ul className="mt-2 ml-6 space-y-2 listUdisc listUinside">
                  <li>プレイヤーはキャラクターを選んで村に参加できます。</li>
                  <li>
                    村の設定で見学可能になっている場合、見物人として参加もできます。
                    <ul className="mt-1 ml-6 space-y-1 listUdisc listUinside">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="space-y-3">
              <Card className="p-4 bg-gray-50">
                ...
                <p className="textUsm">参加していない人も含め全員が見ることができます。</p>
              </Card>
              <Card className="p-4 bgUred-50">
              ...
              <Card className="p-4 bgUpurple-50">
              ...
              <Card className="p-4 bgUgreen-50">
        ...
        <section className="mb-8">
          ...
          <Card className="p-6">
            <ol className="space-y-1 listUdecimal listUinside">
              <li>突然死</li>
              <li>情緒</li>
              <li>冷やし中華</li>
              <li>求愛</li>
          ...
          <Card className="p-6">
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2 space-y-2">
                      <Card className="p-3 bgUblue-50 border-blue-200">
                        <p className="textUsm fontUmono">
              ...
              <div id="psychic">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    メッセージ例
                    <div className="mt-2 space-y-2">
                      <Card className="p-3 bgUpurple-50 borderUpurple-200">
                        <p className="textUsm fontUmono">勇者 アスベルは人狼ではないようだ。</p>
                      </Card>
                      <Card className="p-3 bgUpurple-50 borderUpurple-200">
                        <p className="textUsm fontUmono">勇者 アスベルは人狼のようだ。</p>
                      </Card>
                    </div>
                  </li>
                </ul>
              ...
              <div id="gurupsychic">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2">
                      <Card className="p-3 bgUpurple-50 borderUpurple-200">
                        <p className="textUsm fontUmono">勇者 アスベルは狩人のようだ。</p>
                      </Card>
                    </div>
                  </li>
                </ul>
              ...
              <div id="autopsy">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2">
                      <Card className="p-3 bgUpurple-50 borderUpurple-200">
                        <p className="textUsm fontUmono">勇者 アスベルの死因は呪殺死のようだ。</p>
                      </Card>
                    </div>
                  </li>
                </ul>
              ...
              <div id="guard">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    メッセージ例（エピローグまで見えません）
                    <div className="mt-2">
                      <Card className="p-3 bg-gray-50 borderUgray-200">
                        <p className="textUsm fontUmono">
              ...
              <div id="bake">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    メッセージ例
                    <div className="mt-2 space-y-2">
                      <Card className="p-3 bgUyellow-50 borderUyellow-200">
                        <p className="textUsm fontUmono">
              ...
              <div id="attack">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    メッセージ例
                    <div className="mt-2 space-y-2">
                      <Card className="p-3 bgUred-50 borderUred-200">
                        <p className="textUsm fontUmono">
                          巫女 ウズメ達は、僧侶 セシリーを襲撃した。
                        </p>
                      </Card>
                      <Card className="p-3 bg-gray-100 borderUgray-300">
                        <p className="textUsm fontUmono">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <Card className="p-3 bgUred-50 borderUred-200">
                        <p className="textUsm fontUmono">僧侶 セシリーは狩人だったようだ。</p>
                      </Card>
                      <Card className="p-3 bg-gray-100 borderUgray-300">
                        <p className="textUsm fontUmono">
                          次の日の朝、以下の村人が無惨な姿で発見された。
              ...
              <div id="court">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    メッセージ例
                    <div className="mt-2 space-y-2">
                      <Card className="p-3 bgUpink-50 borderUpink-200">
                        <p className="textUsm fontUmono">
              ...
              <div id="hiyasichuka">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2">
                      <Card className="p-3 bg-gray-100 borderUgray-300">
                        <p className="textUsm fontUmono">[暗] 暗殺者 アシュリーは、始まった。</p>
                      </Card>
                    </div>
                  </li>
                </ul>
              ...
              <div id="emotion">
                ...
                <ul className="space-y-2 listUdisc listUinside textUsm">
                  ...
                  <li>
                    ...
                    <div className="mt-2">
                      <Card className="p-3 bg-gray-100 borderUgray-300">
                        <p className="textUsm fontUmono">[暗] 暗殺者 アシュリーは、終わった。</p>
                      </Card>
                    </div>
                  </li>
                </ul>
            ...
            <ul className="space-y-3 listUdisc listUinside">
              <li>
                ...
                <ul className="mt-2 ml-6 space-y-2 listUdisc listUinside">
                  ...
                  <li className="mt-2">
                    <div className="p-3 border roundedUmd bg-gray-50">
                      <div className="fontUmono textUsm">
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <Card className="p-6">
              <div className="overflowUx-auto">
                <table className="wUfull borderUcollapse border borderUgray-300">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="border borderUgray-300 p-2 textUleft">前提</th>
                      <th className="border borderUgray-300 p-2 textUleft">勝利条件</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border borderUgray-300 p-2">
                        ステータス「恋絆」が付与されている
                      </td>
                      <td className="border borderUgray-300 p-2">恋人陣営の勝利</td>
                    </tr>
                    <tr>
                      <td className="border borderUgray-300 p-2">それ以外</td>
                      <td className="border borderUgray-300 p-2">役職が属する陣営の勝利</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="mb-4">
            ...
            <Card className="p-6">
              <div className="overflowUx-auto mb-4">
                <table className="wUfull borderUcollapse border borderUgray-300">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="border borderUgray-300 p-2 textUleft">陣営</th>
                      <th className="border borderUgray-300 p-2 textUleft">勝利条件</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border borderUgray-300 p-2">恋人陣営</td>
                      <td className="border borderUgray-300 p-2">
                        恋人陣営または恋絆がついた人が1名以上生存
                      </td>
                    </tr>
                    <tr>
                      <td className="border borderUgray-300 p-2">狐陣営</td>
                      <td className="border borderUgray-300 p-2">妖狐系役職が1名以上生存</td>
                    </tr>
                    <tr>
                      <td className="border borderUgray-300 p-2">人狼陣営</td>
                      <td className="border borderUgray-300 p-2">
                        夜明け時点で生存している人狼カウント数 ≧ 生存している人間カウント数
                      </td>
                    </tr>
                    <tr>
                      <td className="border borderUgray-300 p-2">村人陣営</td>
                      <td className="border borderUgray-300 p-2">
                        夜明け時点で生存している人狼カウント数が0人かつ生存している人間カウント数が1人以上
                      </td>
                    </tr>
              ...
              <ul className="listUdisc listUinside">
            ...
            <ul className="space-y-4 listUdisc listUinside">
              ...
              <li>
                ...
                <ul className="mt-2 ml-6 space-y-1 listUdisc listUinside">
                  <li>
                    [[s]]文字列[[/s]] →{' '}
                    <span style={{ textDecoration: 'lineUthrough' }}>文字列</span>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul className="mt-2 ml-6 space-y-1 listUdisc listUinside">
                  <li>
                    [[cw]]文字列[[/cw]] →{' '}
                    <ClickToReveal className="bg-gray-300 cursorUpointer hover:bg-gray-200 px-1 rounded">
                      文字列
                    </ClickToReveal>
                  </li>
                </ul>
