    ...
    >
      <div className="p-4 space-y-6">
        ...
        <section>
          ...
          <div className="flex gap-2 mb-4">
            <Button
              variant="outline"
              size="sm"
              onClick={() => handleToggleAllMessageTypes(true)}
            >
              全て ON
            </Button>
            <Button
              variant="outline"
              size="sm"
              onClick={() => handleToggleAllMessageTypes(false)}
            >
              全て OFF
            </Button>
            <Button
              variant="outline"
              size="sm"
              onClick={handleInvertMessageTypes}
            >
              反転
            </Button>
          </div>
            ...
            {Object.entries(messageTypeLabels).map(([type, label]) => (
              <label key={type} className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  onChange={() => toggleMessageTypeFilter(type as keyof MessageFilterState['messageTypes'])}
        ...
        <section>
          ...
          {/* 一括操作ボタン */}
          <div className="flex gap-2 mb-4">
            <Button variant="outline" size="sm">全て ON</Button>
            <Button variant="outline" size="sm">全て OFF</Button>
            <Button variant="outline" size="sm">反転</Button>
            <Button
              variant="outline"
              size="sm"
